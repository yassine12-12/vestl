...
A beautiful, real-time dashboard displaying weather information and public transit departures for your location. Perfect for mounting near your door to check conditions before heading out!

![Dashboard Preview](https://img.shields.io/badge/React-18-blue) ![TypeScript](https://img.shields.io/badge/TypeScript-5-blue) ![Tailwind CSS](https://img.shields.io/badge/Tailwind-3-blue)

## ✨ Features

- 🌡️ **Live Weather** - Current temperature, conditions, and forecast from OpenWeatherMap
- 🚇 **Transit Departures** - Next 5 departures from your nearest U-Bahn/S-Bahn/Tram stop
- 🔄 **Auto-refresh** - Updates every 60 seconds automatically
- 🎨 **Modern UI** - Dark mode with frosted glass effects
- 📱 **Readable Design** - Large fonts visible from 1-2 meters away
- ⚡ **Fast & Lightweight** - No backend required, direct API calls
